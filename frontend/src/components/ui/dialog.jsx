    ...
    <Headless.Transition appear show={open} {...props}>
      <Headless.Dialog onClose={onClose}>
        <Headless.TransitionChild
          ...
          leaveTo="opacity-0"
        >
          <div className=" z-[1000] fixed inset-0 flex w-screen justify-center overflow-y-auto bg-zinc-950/25 px-2 py-2 focus:outline-0 sm:px-6 sm:py-8 lg:px-8 lg:py-16" />
        </Headless.TransitionChild>

        <div className="z-[1001] fixed inset-0 w-screen overflow-y-auto pt-6 sm:pt-0">
