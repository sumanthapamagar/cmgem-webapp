    ...
    <Headless.Transition appear show={open} {...props}>
      <Headless.Dialog onClose={onClose}>
        <Headless.TransitionChild
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 flex w-screen justify-center overflow-y-auto bg-zinc-950/15 px-2 py-2 focus:outline-0 sm:px-6 sm:py-8 lg:px-8 lg:py-16 " />
        </Headless.TransitionChild>
...
export function AlertTitle({ className, ...props }) {
  return (
    <Headless.DialogTitle
      ...
      className={clsx(
        className,
        'text-balance text-center text-base/6 font-semibold text-black sm:text-wrap sm:text-left sm:text-sm/6 '
      )}
    />
  )
}
