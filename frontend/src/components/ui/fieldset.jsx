...
export function Legend({ className, ...props }) {
  return (
    <Headless.Legend
      ...
      className={clsx(
        className,
        'text-base/6 font-semibold text-black data-disabled:opacity-50 sm:text-sm/6'
      )}
    />
  )
}
...
export function Label({ className, ...props }) {
  return (
    <Headless.Label
      ...
      className={clsx(
        className,
        'select-none text-base/6 text-black data-disabled:opacity-50 sm:text-sm/6'
      )}
    />
  )
}
...
export function Description({ className, ...props }) {
  return (
    <Headless.Description
      ...
      className={clsx(
        className,
        'text-base/6 text-black/60 data-disabled:opacity-50 sm:text-sm/6'
      )}
    />
  )
}
